...
class Bird(object):
    ...
    def __init__(self):
        ...
        # 定义鸟的3种状态列表
        self.birdStatus = [pygame.image.load("../imgs/player.png"),
...
class Pipeline(object):
    ...
    def __init__(self):
        ...
        self.pineUp = pygame.image.load("../imgs/room.png")
        self.pineDown = pygame.image.load("../imgs/room.png")
...
if __name__ == '__main__':
    ...
    while True:
        ...
        background = pygame.image.load("../imgs/point.png")  # 加载背景图片
